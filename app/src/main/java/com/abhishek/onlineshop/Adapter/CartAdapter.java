...
import com.abhishek.onlineshop.Helper.ChangeNumberItemsListener;
import com.abhishek.onlineshop.Helper.ManagmentCart;
import com.abhishek.onlineshop.databinding.ViewholderCartBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder,int position) {
        holder.binding.titleTxt.setText(listItemSelected.get(position).getTitle()); holder.binding.feeEachItem.setText("$" + listItemSelected.get(position).getPrice());
